...
:HTML_CONTAINER_CLASS: code
:END:
- Let's start with some basics. Create a new Python file called The_100_Game.py
...
:HTML_CONTAINER_CLASS: code
:END:
- Save your original =The_100_Game.py= file.
...
:HTML_CONTAINER_CLASS: code
:END:
- Open up your The_100_Game.py file again.
