...
- Look at this link [[https://http://en.wikipedia.org/wiki/ASCII#ASCII_printable_code_chart][ASCII LIST]]
...
- You might need to resize the terminal on Windows - right click the top bad and choose properties
